 ...
 * disp_vdpo_config
 */
typedef struct disp_vdpo_config {
 ...
 */
typedef struct disp_layer_info2 {
    disp_layer_mode            mode;
 ...
 */
typedef struct disp_layer_config2 {
 ...
 * @channel: the channel index of the layer, 0~max-channel-number
 */
typedef struct disp_palette_config {
    unsigned int num;
    void *data;
    unsigned int channel;
} disp_palette_config;
 ...
 */
typedef struct disp_capture_info2 {
  struct disp_rect window;
  struct disp_s_frame2 out_frame;
} disp_capture_info2;

typedef struct disp_capture_fmt {
...
typedef struct disp_capture_buffer {
...
typedef struct disp_capture_handle {
...
typedef struct disp_device_func
{
    ...
    /*for hdmi cec*/
    int (*cec_standby_request)(void);
    int (*cec_send_one_touch_play)(void);
} disp_device_func;
