...
define BuildKernel
  $(warning  "NOTE: Will build kernel[$(KERNEL_BUILD_DIR)].")
...
define BuildSkipKernel
  $(warning  "NOTE: Will skip kernel build.")
  .NOTPARALLEL:
  ...
  download:
	@echo  "The command $$@(include/kernel-build.mk) is banned."

  prepare: $(STAMP_PREPARED)
	@echo  "The command $$@(include/kernel-build.mk) execute."

  compile: $(STAMP_PREPARED)
	$(MAKE) -C ../generic/image compile TARGET_BUILD=
	@echo  "The command $$@(include/kernel-build.mk) execute."

  oldconfig menuconfig nconfig: FORCE
	@echo  "The command $$@(include/kernel-build.mk) is banned."

  install: $(STAMP_PREPARED)
