...
include $(LICHEE_TOP_DIR)/openwrt/build/tinahooks_scan.mk
...
$(FILELIST): $(OVERRIDELIST)
	...
	[ x"$(SCAN_TARGET)" = x"packageinfo" ] && ($(TinaHooks/PackagePre/BuildSoftlink)); \
...
$(TMP_DIR)/.$(SCAN_TARGET): $(TARGET_STAMP)
	[ x"$(SCAN_TARGET)" = x"packageinfo" ] && ($(TinaHooks/PackagePre/BuildSoftlink)) || echo ""
