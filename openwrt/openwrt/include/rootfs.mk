...
define prepare_rootfs
	...
	$(if $(CONFIG_REDUCE_ROOTFS_SIZE), $(LICHEE_TOP_DIR)/openwrt/build/reduce-rootfs-size.sh d $(1))
	$(if $(CONFIG_REDUCE_ROOTFS_SIZE), $(LICHEE_TOP_DIR)/openwrt/build/reduce-rootfs-size.sh c $(1))
endef
